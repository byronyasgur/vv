...
There is no windows installer yet but these instructions have been tested and do work 
( more info https://github.com/bradp/vv/issues/33  - based on @Vinsanity's steps )
